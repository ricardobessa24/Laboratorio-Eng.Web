namespace Utad_Proj_.Controllers
{
    ...
    public class ArticlesController : Controller
    {
        ...
        // POST: Articles/Create To protect from overposting attacks, enable the specific properties
        ...
        public IActionResult Details(int? id)
        {
            ...
            var Comments = _context.ArticlesComments.Where(d => d.ArticleId.Equals(id.Value)).ToList();
            vm.ListOfComments = Comments;

            var ratings = _context.ArticlesComments.Where(d => d.ArticleId.Equals(id.Value)).ToList();
            if (ratings.Count() > 0)
            {
        ...
        // POST: Articles/Edit/5 To protect from overposting attacks, enable the specific properties
        // you want to bind to. For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
